...
#define STRING_CONFIG_H_AUTHOR "(PRINCORE)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "PRINCORE ONE"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp   9.28
    #define DEFAULT_Ki   0.56
    #define DEFAULT_Kd  38.44
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 75.03
  #define DEFAULT_bedKi 11.22
  #define DEFAULT_bedKd 334.50
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 320, 320, 800, 941 }
