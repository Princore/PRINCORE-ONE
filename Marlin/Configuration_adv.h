 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       800        // (mA) RMS current. Multiply by 1.414 for peak current. //550
   ...
   */
  //#define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // All axes (override below) // 1.8er Motoren
